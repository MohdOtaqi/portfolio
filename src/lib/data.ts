...
export const experience: Experience[] = [
  {
    ...
    highlights: [
      ...
      "Created the Swift Monitor dashboard (React 19 + TypeScript, real-time SignalR) with status monitoring, audit trail, template versioning/diff, and OTP/2FA + rate-limited auth.",
      ...
      "Added a CMC Markets FX reader (FIX SecurityList + level-1 bid/ask) to the market-data framework and an OKX exchange connector (WebSocket v5, HMAC-signed) for live/demo order routing.",
    ],
