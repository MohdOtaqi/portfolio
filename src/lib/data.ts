...
export const experience: Experience[] = [
  {
    ...
    highlights: [
      ...
      "Created WatchList dashboard (React + SignalR) for real-time market-data visualization, displaying live price feeds from connected exchange and FX connectors.",
      ...
      "Added CMC Markets FX reader (FIX SecurityList + level-1 bid/ask) and IDC feed readers to the market-data framework; packaged all apps as self-contained installers via Inno Setup and batch scripts.",
